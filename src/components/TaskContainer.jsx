...
const TaskContainer = () => {
  ...
  return (
    <div className=' flex flex-col px-4 overflow-y-scroll md:my-4 p-4 space-y-2 md:w-[700px]  h-[250px] md:h-[350px]
                 bg-slate-200 shadow-sm shadow-blue-200 rounded-xl'>

                    {taskItem.map(({id, description}) => (
                        <div key={id} className='relative md:text-md text-sm flex p-2 space-x-1 bg-white
